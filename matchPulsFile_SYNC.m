function [pulsMatch, dicomStart, dicomEnd] = matchPulsFile_SYNC(dicomDir,pulsDir)
...
%% Find start and end of Dicom and match to puls
dicomStart = dicom.AT(1);
dicomEnd = dicom.AT(end) +dicom.TR_all(end);
